class BulletinsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @bulletin.save
        format.html { redirect_to @bulletin, notice: 'Bulletin이 성공적으로 생성되었습니다.' }
  ...
  def update
    respond_to do |format|
      if @bulletin.update(bulletin_params)
        format.html { redirect_to @bulletin, notice: 'Bulletin이 성공적으로 업데이트었습니다.' }
  ...
  def destroy
    @bulletin.destroy
    respond_to do |format|
      format.html { redirect_to bulletins_url, notice: 'Bulletin이 성공적으로 삭제되었습니다.' }
